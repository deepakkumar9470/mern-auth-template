            ...
            try {
                if(password && confirm_password){
                    ...
                    if( password !== confirm_password ){
                        ...
                        res.status(400).send({"status":"failed", "message":"New Password & Confirm Password dpesn't match"})
                        ...
                        res.status(200).send({"status":"failed", "message":"Password changed successfully.."})
                    }
                ...
                console.log(error)
                res.status(400).send({"status":"failed", "message":"Unable to change password"})
            }
